...
return [
     ...
     */
    'debug' => filter_var(env('DEBUG', true)),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '9a227178856503421e1cebf066f139833766595f67abcd1a2ef9fbcfc7e8ddb7'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 465,
            'timeout' => 30,
            'username' => 'rezwana.mahjabeen.du@gmail.com',
            'password' => '08082014',
            'client' => null,
            'tls' => null,
